    ...
    <div class="max-w-2xl">
            ...
            <div class="card-body">
                <dl class="space-y-4">
                    <div class="flex justify-between">
                        <dt class="text-gray-500">Jenis Maintenance</dt>
                    ...
                    <div class="flex justify-between">
                        <dt class="text-gray-500">Kondisi Setelah</dt>
                    ...
                    <div class="flex justify-between">
                        <dt class="text-gray-500">Jadwal Berikutnya</dt>
        ...
        <div class="card">
            <div class="card-body text-sm text-gray-500">
                <p>Dicatat oleh: {{ $maintenance->creator->name ?? '-' }}</p>
                <p>Tanggal: {{ $maintenance->created_at->format('d M Y H:i') }}</p>
            </div>
        </div>
    </div>
</x-app-layout>
