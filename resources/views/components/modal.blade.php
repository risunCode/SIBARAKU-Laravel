...
<!-- Modal Backdrop -->
<div id="modal-{{ $name }}-backdrop" class="modal-backdrop"></div>

<!-- Modal Content -->
<div id="modal-{{ $name }}" class="modal-content w-full {{ $maxWidthClass }}">
    <div class="rounded-2xl shadow-2xl border" style="background-color: var(--bg-card); border-color: var(--border-color);">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b" style="border-color: var(--border-color);">
            ...
            <button onclick="closeModal('modal-{{ $name }}')" class="p-2 rounded-lg transition-colors hover:opacity-80" style="color: var(--text-secondary);">
